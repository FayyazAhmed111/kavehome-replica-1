export const NAV_JSON = {
  highlights: [
    ...
    { label: "Kave Home & Nexia", href: "/en/en/s/nexia", space: true },
  ...
  inspiration: {
    trending: [
      {
        label: "Here to Stay",
        href: "/en/en/e/here-to-stay",
        image: "/images/navbar-slide-img.avif",
      },
      {
        label: "For Every Season",
        href: "/en/en/s/for-every-season",
    ...
    gallery: [
      {
        label: "Manifesto",
        href: "/en/en/kave-gallery/manifesto",
        image: "/images/navbar-slide-img.avif",
      },
      {
        label: "At the Musée national Picasso-Paris",
        href: "/en/en/kave-gallery/musee-picasso-paris",
        image: "/images/navbar-slide-img.avif",
      },
      {
        label: "View all",
        href: "/en/en/kave-gallery/view-all",
        image: "/images/navbar-slide-img.avif",
      },
      {
        label: "The artists",
        href: "/en/en/kave-gallery/the-artists",
        image: "/images/navbar-slide-img.avif",
      },
      {
        label: "Painting and graphic arts",
        href: "/en/en/kave-gallery/painting-graphic-arts",
        image: "/images/navbar-slide-img.avif",
      },
      {
        label: "Sculpture and volume",
        href: "/en/en/kave-gallery/sculpture-volume",
        image: "/images/navbar-slide-img.avif",
      },
      {
        label: "Textile art",
        href: "/en/en/kave-gallery/textile-art",
        image: "/images/navbar-slide-img.avif",
      },
      {
        label: "Mixed media",
        href: "/en/en/kave-gallery/mixed-media",
        image: "/images/navbar-slide-img.avif",
      },
    ],
  },
