    ...
    >
      ...
      >
        ...
        <div
          ...
          "
        >
          <p className="font-kave text-[20px] leading-[28px] max-w-[480px]">
            Our commitment to responsible practices.
          </p>
          <a
            href="/en/en/kave-cares/"
            className="underline text-[16px] mt-[8px] inline-block hover:opacity-80 font-poppins"
          >
      ...
      >
        {/* Newsletter */}
        <div className="newsletter flex flex-col items-center text-center gap-[16px] mb-[64px]
                        lg:mb-0 lg:items-start lg:text-left lg:max-w-[296px] lg:[grid-area:1/5/1/6] lg:ml-auto">
          <span className="newsletter__title uppercase font-kave tracking-[0.4px] text-[16px] leading-[22px]">
            Subscribe to our newsletter
          </span>
          <a
            title="Subscribe now"
            className="font-poppins border border-[var(--color-neutral-100)] text-[var(--color-neutral-100)] px-6 py-2 rounded hover:bg-[var(--color-neutral-20)] transition w-full max-w-[360px] text-center"
        ...
        >
          {/* ABOUT US */}
          <li className="links-item flex flex-col items-center text-center gap-[16px] md:items-start md:text-left">
            <span className="uppercase font-kave text-[16px] leading-[22px] tracking-[0.4px]">
              ABOUT US
            </span>
            <nav className=" links mt-[16px] flex flex-col gap-[12px] text-center md:text-left font-poppins">
      ...
      {/* Social + Payments */}
      <div
        className="social-payments grid grid-cols-1 items-center gap-[24px] px-[32px] pt-[32px] pb-[24px] border-y border-[var(--color-neutral-30)]
      ...
      {/* Bottom */}
      <div
        className="bottom flex flex-col md:flex-row justify-between items-center 
                    px-[32px] md:px-[80px] xl:px-[96px] py-[16px] gap-3 
                    text-[12px] leading-[18px] text-[var(--color-neutral-70)] font-poppins"
      >
        <ul className="links flex flex-wrap gap-3 text-[var(--color-neutral-80)]">
          {[
        ...
        <div className="copyright text-center md:text-right flex flex-col md:items-end leading-tight text-[var(--color-neutral-70)] font-notosans">
